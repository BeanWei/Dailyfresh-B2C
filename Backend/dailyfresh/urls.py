...
from goods.views import GoodsListViewSet, CategoryViewset, IndexGoodsBannerViewset, IndexTypeViewset, \
    IndexPromotionBannerViewset, NewGoodsViewset, HotGoodsViewset, RecommendGoodsViewset
...
# 首页banner轮播图url
router.register(r'banners', IndexGoodsBannerViewset, base_name="banners")
...
urlpatterns = [
    ...
    path('docs/', include_docs_urls(title='天天生鲜项目文档')),
    # 调试登录
