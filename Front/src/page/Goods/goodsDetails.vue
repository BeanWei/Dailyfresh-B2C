  ...
  <div class="w store-content">
    <div class="gray-box">
      ...
      <div class="banner">
        ...
        <div class="buy">
          <y-button text="加入购物车"
                    @btnClick="addCart(product.id,product.price,product.name,product.image)"
                    classStyle="main-btn"
    ...
    methods: {
      ...
      _productDet (productId) {
        productDet(productId).then(res => {
          this.product = res
          this.productMsg = res.goods.detail || ''
          for (var i = 0; i < res.images.length; i++) {
              this.small[i] = res.images[i].image;
          }
          this.big = res.images[0].image
        })
      },
