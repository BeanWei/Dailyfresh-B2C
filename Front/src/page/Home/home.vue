        ...
        >
          <transition name="fade">
            <div
              ...
              @mouseout="startTimer"
            >
              <img v-if="item.image" class="img1" :src="item.image">
              <img v-if="item.image" class="img2 a" :src="item.image">
              <img v-if="item.image" class="img3 b" :src="item.image">
            </div>
          </transition>
        </div>
        <div class="page">
...
<!-- 
      ...
      <section class="w mt30 clearfix">
        <y-shelf title="新品开售">
          <div slot="content" class="floors">
            <mall-goods :msg="iitem" v-for="(iitem,j) in new_goods" :key="j"></mall-goods>
          </div>
        </y-shelf>
      </section>
      ...
      <section class="w mt30 clearfix">
        <y-shelf title="热门商品">
          <div slot="content" class="floors">
            <mall-goods :msg="iitem" v-for="(iitem,j) in hot_goods" :key="j"></mall-goods>
          </div>
        </y-shelf>
      </section>
      ...
      <section class="w mt30 clearfix">
        <y-shelf title="官方推荐">
          <div slot="content" class="floors">
            <mall-goods :msg="iitem" v-for="(iitem,j) in recommend_goods" :key="j"></mall-goods>
          </div>
        </y-shelf>
      </section>
      <!--         
    ...
    <el-dialog title="通知" :visible.sync="dialogVisible" width="30%" style="width:70%;margin:0 auto">
      <span>欢迎大家Star&Fork, 完整项目地址: github.com/BeanWei/Dailyfresh-B2C</span>
